...
$(document).ready(function(){
  ...
  // Features page - set feature title li to be active if clicked, removing all other active li's
  $('.features-index > li a.feature-title').click(function(e) {
    $('.features-index > li').removeClass("active");
