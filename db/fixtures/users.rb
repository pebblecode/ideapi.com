...
if client && template && creative
  draft_brief = Brief.create(:title => "Draft brief", :author => client, :brief_template => template)
  
  puts "\t- creating published brief"
  to_publish = Brief.create(:title => "Published brief", :author => client, :brief_template => template)
